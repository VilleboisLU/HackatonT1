...
void LoginController::service(HttpRequest& request, HttpResponse& response)
{
    ...
    if (!db.open()){
        ...
        page.append("<form method =\"POST\" action=\"\" class=\"form\">");
        ...
        page.append("<input type=\"email\" class=\"form__input\" name=\"email\" id=\"email-input\">");
        ...
        page.append("<input type=\"password\" id=\"password-input\" name=\"password\" class=\"form__input\">");
        ...
        page.append("const emailError = document.getElementById('email-error');");    
        page.append("const passwordError = document.getElementById('password-error');");    
        page.append("submitBtn.addEventListener('click', (event) = > {");
        page.append("event.preventDefault()");
        page.append("let isValid = true;");
        page.append("emailError.textContent = '';");
        page.append("passwordError.textContent = '';");
